...
const SkillCards = () => {
    const skillsData = [
        ...
        { iconUrl: assets.javascript, iconText: "Javascript", link: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
        { iconUrl: assets.css_logo, iconText: "CSS 3", link: '' },
        { iconUrl: assets.react_logo, iconText: "React JS", link: 'https://expo.dev/' },
        
        { iconUrl: assets.react, iconText: "React Native", link: 'https://reactnative.dev/' },
  ...
  return (
    <div>
         <div>
  <div className={`${styles.section} lg:-mt-80 md:-mt-64 sm:-mt-22`}>
    <div className={`${styles.subSection} flex-col text-center`}>
      <div className={styles.flexWrap}>
        {skillsData.map((skill, index) => (
          <a key={index} href={skill.link}>
            <FeatureCard iconUrl={skill.iconUrl} iconText={skill.iconText} />
          </a>
        ))}
      </div>
    </div>
